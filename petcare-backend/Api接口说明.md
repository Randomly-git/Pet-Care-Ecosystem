...
#### 请求示例
```
GET /api/activities/records/pet/393
GET /api/activities/records/pet/393?startDate=2025-11-11T11:53:24&endDate=2025-11-18T11:53:24
GET /api/activities/records/pet/393?activityKindId=1
GET /api/activities/records/pet/393?startDate=2025-11-11T11:53:24&endDate=2025-11-18T11:53:24&activityKindId=1
```
...
- `statusDescription` (String, 可选): 状态描述
...
- `statusId` (Long, 可选): 新的状态ID
- `startDate` (LocalDate, 可选): 新的开始日期
- `endDate` (LocalDate, 可选): 新的结束日期
- `statusDescription` (String, 可选): 新的状态描述
...
### 2.5 停止状态记录
**PUT** `/records/{statusRecordId}/stop`
